...
{
   // 2016 Electrons
   edm::FileInPath fipEleNotCracks_2016("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2016_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2016.fullPath().data(),"READ");
   h_Ele_notCracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
      
   edm::FileInPath fipEleCracks_2016("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2016_Gap.root");
   root_file = TFile::Open(fipEleCracks_2016.fullPath().data(),"READ");
   h_Ele_Cracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   edm::FileInPath fipEleReco_highPt_2016("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2016.root");
   ...
   edm::FileInPath fipEleReco_lowPt_2016("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2016.root");
   root_file = TFile::Open(fipEleReco_lowPt_2016.fullPath().data(),"READ");
   h_Ele_Reco_lowPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   // 2017 Electrons
   edm::FileInPath fipEleNotCracks_2017("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2017_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2017.fullPath().data(),"READ");
   h_Ele_notCracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   edm::FileInPath fipEleCracks_2017("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2017_Gap.root");
   root_file = TFile::Open(fipEleCracks_2017.fullPath().data(),"READ");
   h_Ele_Cracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   edm::FileInPath fipEleReco_highPt_2017("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2017.root");
   ...
   edm::FileInPath fipEleReco_lowPt_2017("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2017.root");
   root_file = TFile::Open(fipEleReco_lowPt_2017.fullPath().data(),"READ");
   h_Ele_Reco_lowPT_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
      

   // 2018 Electrons
   edm::FileInPath fipEleNotCracks_2018("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2018_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2018.fullPath().data(),"READ");
   h_Ele_notCracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   edm::FileInPath fipEleCracks_2018("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2018_Gap.root");
   root_file = TFile::Open(fipEleCracks_2018.fullPath().data(),"READ");
   h_Ele_Cracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   edm::FileInPath fipEleReco_highPt_2018("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2018.root");
   ...
   edm::FileInPath fipEleReco_lowPt_2018("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2018.root");
   root_file = TFile::Open(fipEleReco_lowPt_2018.fullPath().data(),"READ");
   h_Ele_Reco_lowPT_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   // 2016 Muons
   edm::FileInPath fipMu_2016("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ScaleFactors_mu_Moriond2017_v2.root");
   ...
   // 2017 Muons
   edm::FileInPath fipMu_2017("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/ScaleFactors_mu_Moriond2018_final.root");
   ...
   // 2018 Muons
   edm::FileInPath fipMu_2018("ZZXAnalysis/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_muon_SF_2018RunA2D_ER_2702.root");
