...
namespace {
  cConstantSpline DbkgkinSpline2e2mu("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_2e2mu13TeV.root");
  cConstantSpline DbkgkinSpline4e("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_4e13TeV.root");
  cConstantSpline DbkgkinSpline4mu("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_Dbkgkin_4mu13TeV.root");
  cConstantSpline DbkgVBFdecSpline4l("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DbkgjjEWQCD_4l_JJVBFTagged_13TeV.root");
  cConstantSpline DbkgVBFdecSpline2l2l("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DbkgjjEWQCD_2l2l_JJVBFTagged_13TeV.root");
  cConstantSpline DbkgVHdecSpline4l("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DbkgjjEWQCD_4l_HadVHTagged_13TeV.root");
  cConstantSpline DbkgVHdecSpline2l2l("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DbkgjjEWQCD_2l2l_HadVHTagged_13TeV.root");
  cConstantSpline DVBF2jetsSpline("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DjjVBF13TeV.root");
  cConstantSpline DVBF1jetSpline("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DjVBF13TeV.root");
  cConstantSpline DZHhSpline("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DjjZH13TeV.root");
  cConstantSpline DWHhSpline("$CMSSW_BASE/src/ZZXAnalysis/AnalysisStep/data/cconstants/SmoothKDConstant_m4l_DjjWH13TeV.root");
}
