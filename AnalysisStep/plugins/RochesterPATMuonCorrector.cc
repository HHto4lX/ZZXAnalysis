...
#include <ZZXAnalysis/AnalysisStep/plugins/RoccoR.h>
...
{
  stringstream ss;
  ss << "ZZXAnalysis/AnalysisStep/data/RochesterCorrections/" << identifier_ << ".txt";
  string path_string = ss.str();
  edm::FileInPath corrPath("ZZXAnalysis/AnalysisStep/data/RochesterCorrections/"+identifier_+".txt");
