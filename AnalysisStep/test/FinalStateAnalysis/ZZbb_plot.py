...
import ROOT, math
from ROOT import TFile, TH1F, TCanvas, gSystem, TAttFill, TLegend, TStyle, THStack, kViolet, kBlack, kAzure, kCyan, kGreen, kWhite, kOrange
...
# read files
inFile_ggH125 = TFile.Open('histos_4lbb/histos_ggH125.root')
histos_ggH125 = []
...
inFile_VBFH125 = TFile.Open('histos_4lbb/histos_VBFH125.root')
histos_VBFH125 = []
...
inFile_WplusH125 = TFile.Open('histos_4lbb/histos_WplusH125.root')
histos_WplusH125 = []
...
inFile_WminusH125 = TFile.Open('histos_4lbb/histos_WminusH125.root')
histos_WminusH125 = []
...
inFile_ZH125 = TFile.Open('histos_4lbb/histos_ZH125.root')
histos_ZH125 = []
...
inFile_bbH125 = TFile.Open('histos_4lbb/histos_bbH125.root')
histos_bbH125 = []
...
inFile_ttH125 = TFile.Open('histos_4lbb/histos_ttH125.root')
histos_ttH125 = []
...
inFile_ggTo4e_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo4e_Contin_MCFM701.root')
...
inFile_ggTo4mu_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo4mu_Contin_MCFM701.root')
...
inFile_ggTo4tau_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo4tau_Contin_MCFM701.root')
...
inFile_ggTo2e2mu_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo2e2mu_Contin_MCFM701.root')
...
inFile_ggTo2e2tau_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo2e2tau_Contin_MCFM701.root')
...
inFile_ggTo2mu2tau_Contin_MCFM701 = TFile.Open('histos_4lbb/histos_ggTo2mu2tau_Contin_MCFM701.root')
...
inFile_ZZTo4lext1 = TFile.Open('histos_4lbb/histos_ZZTo4lext1.root')
histos_ZZTo4lext1 = []
...
inFile_TTZJets_M10_MLMext1 = TFile.Open('histos_4lbb/histos_TTZJets_M10_MLMext1.root')
...
inFile_TTZToLL_M1to10_MLM = TFile.Open('histos_4lbb/histos_TTZToLL_M1to1O_MLM.root')
...
inFile_TTWJetsToLNu = TFile.Open('histos_4lbb/histos_TTWJetsToLNu.root')
histos_TTWJetsToLNu = []
...
for name in namelist :
    ...
    # TTW
    histos_TTWJetsToLNu[i].SetFillColor(kOrange+2)
    histos_TTWJetsToLNu[i].SetLineColor(kOrange+2)
