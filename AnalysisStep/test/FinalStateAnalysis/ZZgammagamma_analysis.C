...
void doHisto(const std::string inputFileMC, const std::string outputFile, double lumi=1)
{
  ...
  for (Long64_t entry = 0; entry < entries; entry++)
      ...
      for (int j = 0; j < photonPt->size(); j++)
	{
      ...
      for (int i = 0; i < PhotonVec.size() -1; i++)
	{
...
void ZZgammagamma_analysis(const std::string inputFileMC, const std::string outputFile, double lumi=140) 
{
