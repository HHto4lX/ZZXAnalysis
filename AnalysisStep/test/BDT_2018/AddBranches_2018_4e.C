...
#include "/lustre/home/taliercio/SL7/CMSSW_9_3_2/src/NeuralNetwork_new/dataset_study_2018_4e_all_1bjet1pt/weights/TMVAClassification_BDT_Grad_400_2.class.C"


void AddBranches_2018_4e(){
using namespace std;
//int main (int argc, char ** argv){
  ...
  infile_data.open("bkg_2018_4e.txt");//bari_data_2e2mu_good.txt
  infile_mc.open("bkg_2018_4e.txt");
